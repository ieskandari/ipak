...
$post_fields = array(
    ...
    new field(
        array(
            "name" => "slug", "title" => "نامک", "size" => 1000, "is_uniq" => true, "attr" => array("col-class" => "col-xs-12 col-sm-6 col-md-6 col-lg-9")
        )
    ),
    new field(
        array(
    ...
    new field(array(
        "name" => "img", "title" => "تصویر", "in_table" => false, "type" => "json", "size" => 2000, "file" => "gallery", "attr" => array("col-class" => "col-xs-12 col-sm-6 col-md-6 col-lg-3")
    )),
    new field(
        array(
